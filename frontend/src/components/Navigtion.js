                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: "0.8rem" }}>
                    ...
                    <div style={{ textAlign: "left" }}>
                      ...
                      <div style={{ fontSize: "0.8rem", opacity: 0.7 }}>Dial 988 - Available 24/7</div>
                    </div>
                  </div>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: "0.8rem" }}>
                    ...
                    <div style={{ textAlign: "left" }}>
                      ...
                      <div style={{ fontSize: "0.8rem", opacity: 0.7 }}>Text 741741 - Anonymous help</div>
                    </div>
                  </div>
                  <span style={{ fontSize: "1rem", opacity: 0.5 }}>→</span>
                </button>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: "0.8rem" }}>
                    ...
                    <div style={{ textAlign: "left" }}>
                      ...
                      <div style={{ fontSize: "0.8rem", opacity: 0.7 }}>Calm down with guided breathing</div>
                    </div>
                  </div>
                  <span style={{ fontSize: "1rem", opacity: 0.5 }}>→</span>
                </button>
